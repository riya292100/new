...
const OrderHistoryPage = () => {
  ...
  return (
    <div className="container" style={{ paddingTop: '24px', paddingBottom: '60px', maxWidth: '840px' }}>
      <div style={{ marginBottom: '24px' }}>
        <h1 style={{ fontSize: '1.75rem', color: '#0f172a' }}>My Orders & Deliveries</h1>
        <p style={{ fontSize: '0.9rem', color: '#64748b' }}>Track real-time orders or view past delivery history</p>
      </div>
      ...
      {loading ? (
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', overflowX: 'auto', padding: '4px 0' }}>
                  {order.items?.map((item) => (
                    <div key={item.id} style={{ display: 'flex', alignItems: 'center', gap: '8px', background: '#f8fafc', padding: '6px 10px', borderRadius: '10px', border: '1px solid #f1f5f9', flexShrink: 0 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #f1f5f9', paddingTop: '12px' }}>
                  <div style={{ fontSize: '0.9rem', color: '#64748b' }}>
                    Total: <strong style={{ color: '#0f172a' }}>₹{order.totalAmount}</strong> ({order.items?.length} items)
                  </div>
        ...
        <div style={{ textAlign: 'center', padding: '80px 20px', background: '#ffffff', borderRadius: '20px', border: '1px solid #e2e8f0' }}>
          ...
          <h3 style={{ fontSize: '1.2rem', color: '#0f172a', marginBottom: '8px' }}>No orders placed yet</h3>
          <p style={{ fontSize: '0.88rem', color: '#64748b', marginBottom: '20px' }}>Your ordered groceries and daily essentials will appear here.</p>
