...
import { Zap, MapPin, ChevronDown, ShoppingBag, User, LogOut, Package, Shield, Bike } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <header className="glass-header" style={{ position: 'sticky', top: 0, zIndex: 900 }}>
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexShrink: 0 }}>
          <Link to="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div>
              <span className="brand-font" style={{ fontSize: '1.45rem', fontWeight: '800', color: '#0f172a', letterSpacing: '-0.03em' }}>
                Quick<span style={{ color: '#059669' }}>Cart</span>
              </span>
              <span className="badge badge-delivery" style={{ display: 'block', padding: '1px 6px', fontSize: '0.62rem', marginTop: '-2px' }}>
                ⚡ 12-15 MINS
              </span>
            </div>
          </Link>
          ...
          >
            ...
            <div style={{ overflow: 'hidden' }}>
              ...
              <div style={{ fontSize: '0.84rem', fontWeight: '600', color: '#0f172a', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {selectedLocation?.streetAddress ? `${selectedLocation.label}: ${selectedLocation.streetAddress}` : 'Select Location'}
              </div>
            </div>
          ...
          {user ? (
            <div style={{ position: 'relative' }}>
              ...
              {userDropdownOpen && (
                ...
                >
                  <div style={{ padding: '8px 12px', borderBottom: '1px solid #f1f5f9', fontSize: '0.8rem', color: '#64748b' }}>
