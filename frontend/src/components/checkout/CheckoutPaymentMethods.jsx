...
const CheckoutPaymentMethods = ({ paymentMethod, setPaymentMethod }) => {
  const methods = [
    { key: 'UPI', label: 'UPI (Instant Refund)', desc: 'Google Pay, PhonePe, Paytm, QR', icon: <Smartphone size={20} color="#059669" /> },
    { key: 'CREDIT_CARD', label: 'Credit / Debit Card', desc: 'Visa, Mastercard, RuPay', icon: <CreditCard size={20} color="#2563eb" /> },
    { key: 'CASH_ON_DELIVERY', label: 'Cash on Delivery', desc: 'Pay with Cash / UPI on arrival', icon: <Banknote size={20} color="#d97706" /> },
  ];
          ...
          return (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
                ...
                <div>
                  <div style={{ fontWeight: '700', fontSize: '0.92rem', color: '#0f172a' }}>{m.label}</div>
