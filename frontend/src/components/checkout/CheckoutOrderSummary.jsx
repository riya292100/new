...
const CheckoutOrderSummary = ({
  ...
  return (
    <div style={{ background: '#ffffff', borderRadius: '20px', padding: '24px', border: '1px solid #e2e8f0', display: 'flex', flexDirection: 'column', gap: '20px' }}>
      <h3 style={{ fontSize: '1.15rem', color: '#0f172a' }}>
        Order Summary ({cart?.totalItems || 0} items)
      </h3>

      {/* Applied Coupon / Promo */}
      <div style={{ background: '#f0fdf4', border: '1.5px dashed #10b981', borderRadius: '14px', padding: '14px' }}>
        {appliedCoupon ? (
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button
              ...
              style={{ background: '#fee2e2', color: '#b91c1c', border: 'none', borderRadius: '6px', padding: '4px 8px', fontSize: '0.75rem', fontWeight: '700', cursor: 'pointer' }}
            >
              Remove
            </button>
          </div>
          ...
          <button
            ...
            style={{ width: '100%', background: 'transparent', border: 'none', color: '#059669', fontWeight: '700', fontSize: '0.88rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer' }}
          >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '0.88rem', borderTop: '1px solid #f1f5f9', paddingTop: '14px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '2px solid #0f172a', paddingTop: '12px', marginTop: '4px' }}>
      ...
      <button
        ...
        style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', boxShadow: '0 8px 20px rgba(5, 150, 105, 0.35)' }}
      >
